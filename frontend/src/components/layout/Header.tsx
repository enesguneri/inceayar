    ...
    <header className="sticky top-0 z-40 w-full glass-dark border-b-0 border-white/5 py-3 px-6 flex items-center justify-between">
      ...
      <div className="flex items-center gap-4">
        <div className="relative" ref={dropdownRef}>
          ...
          {showNotifications && (
            <div className="fixed inset-x-4 top-[70px] md:absolute md:inset-x-auto md:right-0 md:top-auto md:mt-2 md:w-80 bg-slate-950/95 backdrop-blur-md border border-white/10 rounded-xl shadow-xl overflow-hidden z-50">
